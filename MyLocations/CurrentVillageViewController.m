//
//  CurrentVillageViewController.m
//  MyVillages
//
...
@interface CurrentVillageViewController () <UITabBarControllerDelegate>

@end

@implementation CurrentVillageViewController
{
...
{
    if ([segue.identifier isEqualToString:@"TagVillage"]) {
...
/*#pragma mark - Logo View
 ...
 _logoButton.center = CGPointMake(self.view.bounds.size.width / 2.0f,
 ...
 panelMover.duration = 0.6; panelMover.fromValue = [NSValue valueWithCGPoint:self.containerView.center];
 ...
 logoMover.duration = 0.5; logoMover.fromValue = [NSValue valueWithCGPoint:_logoButton.center];
